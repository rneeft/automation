...
RootModule = 'Automation.Database'
...
Description = 'Provide scripts for (deployment) automation. It uses DbUp to publish the database scripts.'
...
FunctionsToExport = 'New-Database', 'Publish-DbUpScripts', 'Get-DbUp', 'Test-Database', 
...
HelpInfoURI = 'https://github.com/rneeft/automation/blob/master/README.md'
